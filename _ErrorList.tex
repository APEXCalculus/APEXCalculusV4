...
(240) 12.8 Look at solution to #17. Perhaps more critical points? Depends if the curve is y=\sqrt{4-x^2} or parametrized, perhaps. The given max isn't the correct max. John is dumb.
