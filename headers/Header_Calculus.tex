...
\newcommand{\appendixtextheader}[1]{%
\fancyhead[LE]{\nouppercase{\leftmark}}%
\fancyhead[RO]{\rightmark}%
\fancyfoot[LE]{\begin{minipage}{\textwidth}%
\noindent\hskip\marginparwidth\hskip\marginparsep\hskip0pt\rule{\textwidth}{.4pt}
...
%%
%%%
\newcommand{\appendixoddcheck}{\checkoddpage\ifoddpage\setboolean{oddpg}{true}\else\setboolean{oddpg}{false}\fi}


\newcommand{\appendixmfigure}[5][]{%
		%\ifthenelse{\isodd{\thepage}}%
		  \appendixoddcheck%
			\ifthenelse{\boolean{oddpg}}%
			{\AddToShipoutPicture*{\put(427,\LenToUnit{#2\paperheight}){%
			\begin{minipage}{\marginparwidth}%
				\centering%
	  		\myincludegraphics[#1]{#5}%
