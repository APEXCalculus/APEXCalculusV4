...
pen p=red+linewidth(1);
draw(s1,emissive(rgb(1,.6,.6)+opacity(.8)),meshpen=p);
...
pen p=red+linewidth(1);
draw(s2,emissive(rgb(1,.6,.6)+opacity(.8)),meshpen=p);
...
pen p=red+linewidth(1);
draw(s3,emissive(rgb(1,.6,.6)+opacity(.8)),meshpen=p);
...
pen p=red+linewidth(1);
draw(s4,emissive(rgb(1,.6,.6)+opacity(.8)),meshpen=p);
