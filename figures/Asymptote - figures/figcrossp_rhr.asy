...
draw((0,0,0)--(-1/5,1,1/5), Arrow3(size=3mm));
label("$\vec{u}$",(-1/5,1,1/5),N);

// Draw  \vec{v}=<-6/5,3/5,1/5>
draw((0,0,0)--(-6/5,3/5,1/5), Arrow3(size=3mm));
label("$\vec{v}$",(-6/5,3/5,1/5),N);

// Draw the cross product of u and v <2,-5,27> but scale it as <2,-5,27>/25
draw((0,0,0)--(2/25,-5/25,27/25), Arrow3(size=3mm));
label("$\vec{u} \times \vec{v}$",(2/25,-5/25,27/25),N);
