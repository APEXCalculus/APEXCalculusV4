...
real[] myzchoice={};
defaultpen(0.5mm);
xaxis3("$x$",-2,2,black,OutTicks(myxchoice),Arrow3(size=3mm));
yaxis3("$y$",-2,2,black,OutTicks(myychoice),Arrow3(size=3mm));
zaxis3("$z$",-2,2,black,OutTicks(myzchoice),Arrow3(size=3mm));
