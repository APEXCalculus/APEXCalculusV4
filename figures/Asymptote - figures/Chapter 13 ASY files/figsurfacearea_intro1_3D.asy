...
//along fixed x
draw((0,-.3,0) -- (0,.3,0),linewidth(.75));
draw((.2,-.4,0) -- (.2,.4,0),linewidth(.75));
draw((0.4,-.6,0) -- (.4,.6,0),linewidth(.75));
draw((0.6,-.7,0) -- (.6,.7,0),linewidth(.75));
draw((.8,-.8,0) -- (.8,.8,0),linewidth(.75));
draw((1,-.8,0) -- (1,.8,0),linewidth(.75));
draw((1.2,-.8,0) -- (1.2,.8,0),linewidth(.75));
draw((1.4,-.8,0) -- (1.4,.8,0),linewidth(.75));
draw((1.6,-.7,0) -- (1.6,.7,0),linewidth(.75));
draw((1.8,-.6,0) -- (1.8,.6,0),linewidth(.75));
draw((2,-.4,0) -- (2,.4,0),linewidth(.75));
//along fixed y
draw((.8,.8,0) -- (1.4,.8,0),linewidth(.75));
draw((.6,.7,0) -- (1.6,.7,0),linewidth(.75));
draw((.4,.6,0) -- (1.8,.6,0),linewidth(.75));
draw((.4,.5,0) -- (1.8,.5,0),linewidth(.75));
draw((.2,.4,0) -- (2,.4,0),linewidth(.75));
draw((0,.3,0) -- (2,.3,0),linewidth(.75));
draw((0,.2,0) -- (2,.2,0),linewidth(.75));
draw((0,.1,0) -- (2,.1,0),linewidth(.75));
draw((.8,-.8,0) -- (1.4,-.8,0),linewidth(.75));
draw((.6,-.7,0) -- (1.6,-.7,0),linewidth(.75));
draw((.4,-.6,0) -- (1.8,-.6,0),linewidth(.75));
draw((.4,-.5,0) -- (1.8,-.5,0),linewidth(.75));
...
draw((1.6,.3,0) -- (1.6,.4,0) -- (1.8,.4,0) -- (1.8,.3,0) --cycle,blue+linewidth(2));
