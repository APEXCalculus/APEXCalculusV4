...
import three;
path3 p =  (1.6,-0.65,0)--(1.6,0.65,0) -- (1.6,0.65,1.65)..(1.6,0,1.8)..(1.6,-0.65,1.65); 
draw(surface(p -- cycle), emissive(red+opacity(0.7)));
//draw the edge in thick red
draw((1.6,-0.65,0)--(1.6,0.65,0)--(1.6,0.65,1.625)..(1.6,0,1.825)..(1.6,-0.65,1.625)--(1.6,-0.65,0),red+linewidth(2)); 
