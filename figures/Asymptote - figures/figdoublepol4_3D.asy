...
currentprojection=orthographic(4,4,15);
...
draw(surface(mypath1 -- cycle), emissive(rgb(.6,.6,1)+opacity(0.7)));
...
draw(surface(mypath--cycle), emissive(rgb(.6,.6,1)+opacity(0.7)));
