{$f(x,y) = 10-2\sqrt{x^2+y^2}$ over $R$, bounded by the circle $x^2+y^2=25$. (This is the cone with height 10 and base radius 5; be sure to compare your result with the known formula.)
}
