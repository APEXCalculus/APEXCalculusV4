{Find the surface area of the sphere with radius 5 by doubling the surface area of $f(x,y) = \sqrt{25-x^2-y^2}$ over $R$, bounded by the circle $x^2+y^2=25$. (Be sure to compare you result with the known formula.)
}
