{Let lines $\vec \ell_1(t)$ and $\vec \ell_2(t)$ be intersecting lines. Show why the distance formula correctly gives the distance between these lines as $0$.\label{10_05_ex_30}
}
