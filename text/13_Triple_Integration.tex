...
\mnote{.75}{\textbf{Note:} Example \ref{ex_trip2} uses the term ``first octant.'' Recall how the $x$-, $y$- and $z$-axes divide space into eight \emph{octants}; the octant in which $x$, $y$ and $z$ are all positive is called the \emph{first octant}.}
...
3Dcoo=3.675152540206909 -7.818903923034668 16.216196060180664,
3Droo=150.00000119319247,
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.4}{Finding the center of mass of this solid in Example \ref{ex_trip7}.}{fig:trip7}{figures/figtrip2}
