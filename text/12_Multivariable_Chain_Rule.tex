...
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.7}{Understanding the application of the Multivariable Chain Rule.}{fig:mchain_intro}{figures/figmchain_intro}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.35}{Plotting the path of a particle on a surface in Example \ref{ex_mchain2}.}{fig:mchain2}{figures/figmchain2}
