...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.75}{Understanding the directional derivative in Example \ref{ex_direct1}.}{fig:direct1}{figures/figdirect1}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.32}{At the top of a paraboloid, all directional derivatives are 0.}{fig:direct9}{figures/figdirect9}
