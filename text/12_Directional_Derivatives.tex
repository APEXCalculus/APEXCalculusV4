...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.1}{.75}{Understanding the directional derivative in Example \ref{ex_direct1}.}{fig:direct1}{figures/figdirect1}
...
\mtable{.68}{Graphing the surface and important directions in Example \ref{ex_direct2}.}{fig:direct2}{%
\begin{tabular}{c}
...
3Droo=150,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{figures/figdirect2}\\
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.32}{At the top of a paraboloid, all directional derivatives are 0.}{fig:direct9}{figures/figdirect9}
