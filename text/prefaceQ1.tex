...
This text is Part 1 of a four--text series on Calculus, divided to meet the needs of some schools that use the quarter system. This first part covers ``differential calculus'': limits, derivatives and their applications, found in Chapters 1 through 4. The second text covers ``integral calculus'': antiderivatives, integration and its applications, found in Chapters 5 through 7. along with an introduction to sequences, series and Taylor Polynomials, found in Chapters 5 through 8. The third text covers topics common in ``Calc 3'' or ``multivariable calc:'' parametric equations, polar coordinates, vector--valued functions, and functions of more than one variable, found in Chapters 9 through 14. All three are available separately for free at \texttt{\href{http://apexcalculus.com}{www.apexcalculus.com}}. These three texts are intended to work together and make one cohesive text, \textit{APEX Calculus}, which can also be downloaded from the website. 
