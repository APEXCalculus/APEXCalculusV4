...
\definition{def:line_integral2}{Line Integral Over Vector Field}
...
\mfigure{.35}{Paths through a vector field in Example \ref{ex_livf2}.}{fig:livf2}{figures/figlivf2}
