...
3Dlights=Headlamp,add3Djscript=asylabels.js}{scale=1.5,trim=0mm 0mm 0mm 0mm, clip}{.78}{Finding the surface area of a cone in Example \ref{ex_surfacearea3}.}{fig:surfacearea3}{figures/figsurfacearea3}
