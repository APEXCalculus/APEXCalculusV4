...
3Dcoo=72.58285522460938 2.891160011291504 -26.545438766479492,
3Droo=149.99998703790175,
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.4}{Revolving $y=\sin x$ on $[0,\pi]$ about the $x$-axis.}{fig:sa1}{figures/figsa1}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.35}{A graph of Gabriel's Horn.}{fig:gabriel}{figures/figgabriel}
