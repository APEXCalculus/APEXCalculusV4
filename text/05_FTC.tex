...
%} %end longpage
%{%not longpage
\mtable{.4}{In (a), a graph of $y=f(x)$ and the rectangle guaranteed by the Mean Value Theorem. In (b), $y=f(x)$ is shifted down by $f(c)$; the resulting ``area under the curve'' is 0.}{fig:ftc9}
{\begin{tabular}{c}
