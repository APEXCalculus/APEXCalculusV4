...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.75}{Graphing the canoncial surfaces in cylindrical coordinates from Example \ref{ex_cylindrical1}.}{fig:cylindrical1}{figures/figcylindrical1}
