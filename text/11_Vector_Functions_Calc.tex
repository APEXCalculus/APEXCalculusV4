...
\mnote{.85}{\textbf{Note:} again, using one-sided limits, we can define differentiability on closed intervals. We'll make use of this a few times in this chapter.}
\enlargethispage{2\baselineskip}
...
3Droo=150.0000027221829,3Dlights=Headlamp,add3Djscript=asylabels.js}{width=125pt}{.8}{Viewing a vector--valued function and its derivative at one point.}{fig:vvflimit4}{figures/figvvflimit4}
}%% ends "if in threeD"
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.35}{Graphing a curve in space with its tangent line.}{fig:vvfderiv1}{figures/figvvfderiv1}
}%end in threeD
