...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.75}{Graphing $f$ in Example \ref{ex_tpl2}.}{fig:tpl2}{figures/figtpl2}
...
Q_1 &= \ell_n(4) & Q_2 &= \ell_n(-4) \\
  &\approx \la 3.63, -2.27, 2.37\ra & & \approx\la 0.37, 4.27, 5.63\ra
	\end{align*}
width=150pt\mfigurethree{width=150pt,3Dmenu,activate=onclick,deactivate=onclick,
3Droll=0,
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.65}{Graphing a surface with  tangent plane from Example \ref{ex_tpl6}.}{fig:tpl6}{figures/figtpl6}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.73}{An ellipsoid and its tangent plane at a point.}{fig:tpl8}{figures/figtpl8}
