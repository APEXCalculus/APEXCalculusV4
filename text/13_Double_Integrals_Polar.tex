...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.55}{Evaluating a double integral with polar coordinates in Example \ref{ex_doublepol1}.}{fig:doublepol1}{figures/figdoublepol1}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.58}{The surface and region $R$ used in Example \ref{ex_doublepol5}.}{fig:doublepol5}{figures/figdoublepol5}
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{.4}{Visualizing the solid used in Example \ref{ex_doublepol4}.}{fig:doublepol4}{figures/figdoublepol4} 
}
